defmodule PayPalPaymentsTest do
  ...
  test "show a sale" do
    use_cassette "sale_show" do
      ...
      assert resp == {:ok, %{amount: %{currency: "USD", details: %{handling_fee: "1.00", insurance: "0.01", shipping: "0.03", shipping_discount: "-1.00", subtotal: "30.00", tax: "0.07"}, total: "30.11"}, create_time: "2017-05-09T02:54:14Z", custom: "EBAY_EMS_90048630024435", id: "7UB09546JJ671102D", invoice_number: "48787589673", links: [%{href: "https://api-m.sandbox.paypal.com/v1/payments/sale/7UB09546JJ671102D", method: "GET", rel: "self"}, %{href: "https://api-m.sandbox.paypal.com/v1/payments/sale/7UB09546JJ671102D/refund", method: "POST", rel: "refund"}, %{href: "https://api-m.sandbox.paypal.com/v1/payments/payment/PAY-56X02727YH154025YLEISYVI", method: "GET", rel: "parent_payment"}], parent_payment: "PAY-56X02727YH154025YLEISYVI", payment_mode: "INSTANT_TRANSFER", protection_eligibility: "ELIGIBLE", protection_eligibility_type: "ITEM_NOT_RECEIVED_ELIGIBLE,UNAUTHORIZED_PAYMENT_ELIGIBLE", soft_descriptor: "PAYPAL *TESTFACILIT ECHI5786786", state: "completed", transaction_fee: %{currency: "USD", value: "1.32"}, update_time: "2017-05-09T02:54:14Z"}}
    end
  end
  ...
  test "refund a sale" do
    use_cassette "sale_refund" do
      ...
      assert resp == {:ok, %{amount: %{currency: "USD", total: "1.50"}, create_time: "2017-05-09T04:59:50Z", id: "6N458369VN1308144", links: [%{href: "https://api-m.sandbox.paypal.com/v1/payments/refund/6N458369VN1308144", method: "GET", rel: "self"}, %{href: "https://api-m.sandbox.paypal.com/v1/payments/payment/PAY-56X02727YH154025YLEISYVI", method: "GET", rel: "parent_payment"}, %{href: "https://api-m.sandbox.paypal.com/v1/payments/sale/7UB09546JJ671102D", method: "GET", rel: "sale"}], parent_payment: "PAY-56X02727YH154025YLEISYVI", sale_id: "7UB09546JJ671102D", state: "completed", update_time: "2017-05-09T04:59:50Z"}}
    end
  end
    ...
    use_cassette "refund_show" do
      ...
      assert resp == {:ok,
                           %{amount: %{currency: "USD", total: "-1.50"},
                             ...
                             invoice_number: "48787589673",
                             links: [%{href: "https://api-m.sandbox.paypal.com/v1/payments/refund/6N458369VN1308144",
                                method: "GET", rel: "self"},
                              %{href: "https://api-m.sandbox.paypal.com/v1/payments/payment/PAY-56X02727YH154025YLEISYVI",
                                method: "GET", rel: "parent_payment"},
                              %{href: "https://api-m.sandbox.paypal.com/v1/payments/sale/7UB09546JJ671102D",
                                method: "GET", rel: "sale"}],
